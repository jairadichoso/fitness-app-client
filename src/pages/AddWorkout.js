...
export default function AddWorkout() {
    ...
    const addWorkout = async (e) => {
        ...
        try {
            const response = await fetch('https://fitness-app-q2bc.onrender.com/workouts/addWorkout', {
                method: 'POST',
                headers: {
                ...
                <Form onSubmit={e => addWorkout(e)}>
...

                    {
                        isActive ?
                            ...
                            :
                            <Button variant="primary" type="submit" id="submitBtn" className='my-2' disabled>Submit</Button>
                    }
                </Form>
        }
        </>
